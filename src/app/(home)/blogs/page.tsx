      ...
      <section className="flex">
        <div className="items-center space-y-1">
          <div>
            <div className=" mt-10 justify-left border-slate-25 border-2 rounded-lg w-[1000px] m-[50px] ml-15 ">
              <div className="flex">
                <div>
                  <img
                    src="/assets/images/blogs/water.png"
                    alt="image"
            ...
            <div className="ml-25 w-[1000px] h-[202px] sm:container mx-auto sm:container mx-auto">
              <div className="flex">
                <div className="flex-shrink-0 w-[500px] h-[442px] m-[20px] ml-[50px] border-slate-250 border-2 rounded-lg ">
                  <img
                    src="/assets/images/blogs/equipments.png"
                    alt="blog_banner"
                ...
                <div className="flex-shrink-0 w-[500px] h-[442px] ml-[50px] m-[20px] border-slate-250 border-2 rounded-lg ">
                  <img
                    src="/assets/images/blogs/workout.png"
                    alt="blog_banner"
                  ...
                  <p className="font-normal t-2 ml-5">
                    Lorem ipsum dolor sit amet, consectetur iscing elit, sed do
                    eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    Ut enim ad minim veniam, quis
                  </p>
            ...
            <div className="w-[1000px] h-[202px]">
              <div className="flex mt-[300px]">
                ...
                <div className="flex-shrink-0 w-[450px] h-[442px] ml-[50px] m-[20px] border-slate-250 border-2 rounded-lg ">
                  <img
                    src="/assets/images/blogs/blog_img.png"
                    alt="blog_banner"
                    className=" w-[450px] object-cover h-[215px] flex-shrink rounded-lg "
                  />
                  <h1 className="font-bold mt-5 ml-5">
          ...
          <div className="m-[100px">
            <button className="w-[70px] text-black border-slate-250 border-2 mt-[330px] ml-[480px]">
              &lt;&lt;Pre
            </button>
